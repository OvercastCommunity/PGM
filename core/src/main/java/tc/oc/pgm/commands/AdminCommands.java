...
public class AdminCommands {
  ...
  public static void end(CommandSender sender, Match match, @Nullable @Text String target)
    ...
    if (target != null && winner == null)
      throw new CommandException(
          Translations.get().translate("command.competitorNotFound", sender));

    boolean ended = match.finish(winner);

    if (!ended)
      throw new CommandException(
          Translations.get().translate("command.admin.end.unknownError", sender));
  }
  ...
  public static void setNext(
    ...
    if (RestartManager.isQueued() && !force) {
      throw new CommandException(
          Translations.get().translate("command.admin.setNext.restartQueued", sender));
    }
  ...
  public static void cancel(CommandSender sender, Match match) {
    ...
    sender.sendMessage(
        ChatColor.GREEN + Translations.get().translate("command.admin.cancel.success", sender));
  }
  ...
  public void pgm(CommandSender sender) {
    ...
    sender.sendMessage(ChatColor.GREEN + Translations.get().translate("command.admin.pgm", sender));
  }
