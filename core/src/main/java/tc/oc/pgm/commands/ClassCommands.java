...
public class ClassCommands {
  ...
  public static void selectClass(
    ...
    if (search == null) {
      ...
      sender.sendMessage(
          ChatColor.GREEN
              + Translations.get().translate("command.class.view.currentClass", player.getBukkit())
              + " "
              + ChatColor.GOLD
              + ChatColor.UNDERLINE
              + cls.getName());
      ...
      if (result == null) {
        throw new CommandException(
            Translations.get().translate("command.class.select.classNotFound", player.getBukkit()));
      }
      ...
      try {
        ...
        throw new CommandException(
            Translations.get().translate("command.class.stickyClass", player.getBukkit()));
      }
  ...
  public static void listclasses(CommandSender sender, Match match) throws CommandException {
    ...
    sender.sendMessage(
        StringUtils.dashedChatMessage(
            ChatColor.GOLD + Translations.get().translate("command.class.list.title", sender),
            "-",
  ...
  private static ClassMatchModule getClassModule(Match match, CommandSender sender)
    ...
    if (classModule != null) {
      ...
      throw new CommandException(Translations.get().translate("command.class.notEnabled", sender));
    }
  }
}
