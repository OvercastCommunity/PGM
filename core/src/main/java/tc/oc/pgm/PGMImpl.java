...
import tc.oc.pgm.util.MatchNameRenderer;
import tc.oc.pgm.util.NicknameRenderer;
import tc.oc.util.FileUtils;
import tc.oc.util.bukkit.chat.Audience;
import tc.oc.util.named.CachingNameRenderer;
import tc.oc.util.named.Names;
...
public class PGMImpl extends JavaPlugin implements PGM {
  ...
  public void onEnable() {
    ...
    Names.setRenderer(new NicknameRenderer());
    ...
    Names.setRenderer(new CachingNameRenderer(matchNameRenderer));
