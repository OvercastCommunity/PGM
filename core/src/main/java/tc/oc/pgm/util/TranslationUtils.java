...
import tc.oc.util.named.Named;
import tc.oc.util.named.StyledNameFunction;
import tc.oc.util.translations.Translations;
import tc.oc.util.translations.Translator;
import tc.oc.util.translations.provider.TranslationProvider;

public class TranslationUtils {

  private static final Translator TRANSLATOR = Translations.get();
