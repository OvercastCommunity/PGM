 ...
 *
 * <p>This component checks if the pattern provided exists in {@link
 * tc.oc.util.translations.Translations}, if it does, it returns a translated {@link
 * PersonalizedText} component using the arguments. If it doesn't exist, it uses a default {@link
 * TranslatableComponent} as a fallback
 */
public class PersonalizedTranslatable extends Component {
  ...
  public BaseComponent render(CommandSender viewer) {
    ...
    String pattern = Translations.get().getPattern(component.getTranslate(), viewer);
